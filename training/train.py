...
parser.add_argument('--detector_path', type=str,
                    default='/home/weicheng/Experiments/Deep/DeepfakeBench/training/config/detector/spsl.yaml',
...
def main():
    ...
    with open('/home/weicheng/Experiments/Deep/DeepfakeBench/training/config/train_config.yaml', 'r') as f:
    ...
    if config['lmdb']:
        config['dataset_json_folder'] = '/scratch/weicheng/DeepfakeBench/preprocessing/dataset_json'
    # create logger
